    ...
    return(
        <Container>
            <div className='w-full min-h-screen flex justify-center items-center flex-col gap-4'>
                ...
                <p className="font-bold text-2xl">- Seu Cadastro... -</p>
                ...
                <button type='submit' className='bg-red-600 w-full rounded-md text-white h-10 text-xl hover:scale-105 transition-all'>
                    Cadastrar
                </button>
